          ...
          >
             ...
             <div className="flex flex-wrap gap-3 relative z-10">
               {portfolioData.skills.languages.map((skill, i) => (
                 <motion.div key={i} variants={skillItem} className="px-4 py-2 bg-white/5 border border-white/10 rounded-xl text-zinc-300 hover:bg-white/10 hover:text-white transition-colors cursor-default">
                   {skill}
                 </motion.div>
               ))}
             </div>
          ...
          >
             ...
             <div className="flex flex-col gap-3 relative z-10">
               {portfolioData.skills.core.map((skill, i) => (
                 <motion.div key={i} variants={skillItem} className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl text-zinc-300">
